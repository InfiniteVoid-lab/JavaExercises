...
public class NF3_B11_1 {

    public static void main(String[] args) {

        // Donada una matriu 4x4 de nombres enters, que s'ha d'emplenar amb nombres
        // aleatoris entre --9 i 9, calcula la suma dels nombres del seu perímetre./
        ...
        // Sumar las columnas, la primera y la ultima pones el length a -1 para no
        // repetir el numero
